...
const DOCUMENTS = {
  terms: {
    title: "用户协议",
    intro: "欢迎使用 AI 学习助手。请在使用服务前认真阅读本协议；注册、登录或继续使用服务，即表示你理解并同意本协议的约定。",
    sections: [
      ["agreement", "一、协议说明", "本协议适用于 AI 学习助手提供的学习服务。当前版本为 V1.0，更新日期为" + UPDATED_AT + "。平台可在合理范围内更新本协议，并在页面公布更新后的内容。"],
  ...
  privacy: {
    title: "隐私政策",
    intro: "本政策说明 AI 学习助手在提供当前功能时处理哪些个人信息、用于什么目的，以及你目前可以使用的相关控制方式。",
    sections: [
      ["scope", "一、适用范围", "本政策适用于 AI 学习助手当前提供的服务，版本为 V1.0，更新日期为" + UPDATED_AT + "。平台遵循合法、正当、必要、诚信、公开透明、目的直接相关和最小范围的原则处理信息。"],
    ...
    <main className="legal-page">
      <div className="legal-shell">
        <header className="legal-header">
          <a className="legal-brand" href="/" aria-label="返回登录或注册">AI 学习助手</a>
