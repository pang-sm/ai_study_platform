...
export default function ExamStudyPlan({
  ...
  const fetchPlan = useCallback(async () => {
    ...
    try {
      ...
      const apiPath = isCourseMode
        ? `/api/course-learning/study-plan?username=${encodeURIComponent(username)}&course_id=${encodeURIComponent(targetCourse)}`
  ...
  const deleteTask = async (taskId) => {
    ...
    try {
      const targetCourse = courseId || courseName || "course";
      const apiPath = isCourseMode
        ? `/api/course-learning/study-plan/tasks/${taskId}?username=${encodeURIComponent(username)}&course_id=${encodeURIComponent(targetCourse)}`
