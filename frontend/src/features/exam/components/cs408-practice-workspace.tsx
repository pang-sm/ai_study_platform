...
function chapterLabel(chapter?: { chapter_no: number; chapter_title: string }) {
  return chapter ? `第 ${chapter.chapter_no} 章 · ${chapter.chapter_title}` : '选择章节后开始练习';
}
