...
const hit = t.includes("已上传") || t.includes("无需重复") || t.includes("已存在于");
console.log("has duplicate message:", hit);
const idx = t.indexOf("已上传");
if (idx >= 0) console.log("context:", JSON.stringify(t.slice(Math.max(0,idx-30), idx+120)));
await browser.close();
