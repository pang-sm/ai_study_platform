...
await page.waitForTimeout(2800);
console.log("COURSE F5前 URL:", page.url(), "files:", JSON.stringify(await files()));
await page.reload({ waitUntil: "domcontentloaded" });
await page.waitForTimeout(4000);
console.log("COURSE F5后 URL:", page.url(), "files:", JSON.stringify(await files()));
await page.reload({ waitUntil: "domcontentloaded" });
await page.waitForTimeout(4000);
console.log("COURSE CtrlF5后 URL:", page.url(), "files:", JSON.stringify(await files()));
...
console.log("EXAM F5前 URL:", page.url(), "files:", JSON.stringify(await files()));
await page.reload({ waitUntil: "domcontentloaded" });
await page.waitForTimeout(4000);
console.log("EXAM F5后 URL:", page.url(), "files:", JSON.stringify(await files()));
await page.reload({ waitUntil: "domcontentloaded" });
await page.waitForTimeout(4000);
console.log("EXAM CtrlF5后 URL:", page.url(), "files:", JSON.stringify(await files()));
await browser.close();
