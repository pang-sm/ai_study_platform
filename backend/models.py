...
class StudyMaterial(Base):
    ...
    study_mode = Column(String(20), nullable=False, default="general")
...
class CourseLearningPreference(Base):
    ...
    note = Column(Text, nullable=True)
    default_mode = Column(String(20), nullable=False, default="daily")
    primary_mode = Column(String(20), nullable=False, default="daily")
    show_mode_priority = Column(Boolean, nullable=False, default=True)
...
class ProgrammingExercise(Base):
    ...
    quality_status = Column(String(20), nullable=False, default="needs_review", index=True)
    quality_score = Column(Float, nullable=False, default=0)
    quality_failure_reasons = Column(Text, nullable=False, default="[]")
    learning_objective_id = Column(String(160), nullable=True, index=True)
    learning_objective = Column(Text, nullable=True)
    prerequisites = Column(Text, nullable=True)
    core_skill = Column(Text, nullable=True)
    novelty_reason = Column(Text, nullable=True)
    reviewed_at = Column(Text, nullable=True)
    background_knowledge_zh = Column(Text, nullable=True)
    hints_zh = Column(Text, nullable=True)
    knowledge_point_ids = Column(Text, nullable=False, default="[]")
    primary_knowledge_point_id = Column(Integer, nullable=True)
    prerequisite_knowledge_point_ids = Column(Text, nullable=False, default="[]")
    curriculum_module = Column(String(120), nullable=True)
...
class UserKnowledgeProgress(Base):
    ...
    status = Column(String(30), nullable=True)
    user_confirmed_status = Column(String(30), nullable=True)
    system_suggested_status = Column(String(30), nullable=True)
    ai_recommended_status = Column(String(30), nullable=True)
